...
class KiopsTestCases(cuda_test.CudaTestCases):
    tolerance: float
    cpu_to_gpu_tolerence: float
    rand: random.Random
    ...
    def test_compare_cpu_to_gpu(self):
        ...
        self.assertLessEqual(relative_diff_w1, self.cpu_gpu_tolenrance, f'Kiops didn\'t give a close result to the cpu value')
        self.assertLessEqual(relative_diff_w2, self.cpu_gpu_tolenrance, f'Kiops didn\'t give a close result to the gpu value')
