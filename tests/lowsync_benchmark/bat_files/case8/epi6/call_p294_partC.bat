...
methods=("galewsky_cwyne.ini" "galewsky_pmex1s.ini" "galewsky_cwyne1s.ini" "galewsky_kiops_ne.ini" "galewsky_kiops.ini" "case6_cwyne1s.ini" "case6_pmex1s.ini" "case6_kiops_ne.ini")
