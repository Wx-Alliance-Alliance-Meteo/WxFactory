...
\begin{quote}
\textbf{Historical design note.} The solver and multigrid-preconditioner sections in this
document describe earlier GEF experiments and are not a specification of the current WxFactory
implementation.
\end{quote}
