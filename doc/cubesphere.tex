...
\begin{frame}{Document status}
    This presentation is an historical overview. Its performance and solver statements describe
    an earlier implementation and are not current WxFactory documentation.
\end{frame}
