...
\begin{quote}
\textbf{Historical design note.} This document describes an experimental GEF RAT-2
preconditioning design that is not present in the current WxFactory implementation.
\end{quote}
