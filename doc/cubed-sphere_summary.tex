...
\title{\bf A summary of the equations of motion on the cubed-sphere and latitude-longitude coordinates under the shallow-atmosphere and spherical geopotential approximations}
...
\begin{quote}
\textbf{Document status.} This is a mathematical derivation under the approximations named in the
title, not a line-by-line specification of the current WxFactory implementation.
\end{quote}
