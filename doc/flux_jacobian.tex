...
\begin{quote}
\textbf{Document status.} This is a mathematical derivation, not a line-by-line specification of
the current WxFactory implementation.
\end{quote}

\begin{abstract}
Flux Jacobians are derived.
\end{abstract}
