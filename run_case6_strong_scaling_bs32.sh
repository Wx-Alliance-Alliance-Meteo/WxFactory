...
#PBS -l select=20:ncpus=80:mem=400gb:mpiprocs=80:ompthreads=1
...
# EXODE methods 
exodemethod="BS32" 
#'BS32','DP54', 'M43','KC32','EXLRK32','EXLRK43','DP87', 'EXLRK4(3)MINA5'

for EPImethod in $EPImethod_sel 
do
	# Testoutput location and file
	testoutputDir=./testoutput/case6/ 
	#/space/hall6/sitestore/eccc/mrd/rpnatm/siw001/testoutput/case6/work_precision/
