...
_m = 13
_expm_b: NDArray[cp.floating] = cp.array([_fact(2*_m - k) * _fact(_m) / _fact(2*_m) / _fact(_m - k) / _fact(k) for k in range(_m + 1)])
del _fact, _m

_expm_theta13: NDArray[cp.floating] = cp.array(5.371920351148152)
