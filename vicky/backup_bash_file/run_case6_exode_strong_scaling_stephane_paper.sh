...
#SBATCH --mem=300G
#SBATCH --time=2:00:00
#SBATCH --output=vicky/EXODE_testoutput_case6/run_scripts/case6_exode_strong_scaling_%j.out
#SBATCH --error=vicky/EXODE_testoutput_case6/run_scripts/case6_exode_strong_scaling_%j.err
...
testoutputDir=$GEFDir/vicky/EXODE_testoutput_case6/${EPImethod}/strong_scaling
mkdir $testoutputDir
...
nb_elements_sel="168"
nb_elements=168
num_of_cores="294 864 1176 2646"
tf=14400

tol=1e-12

# EXODE methods 
exodemethod="RK23" # RK23 RK45 MERSON4 ARK3(2)4L[2]SA-ERK ERK3(2)3L ERK4(3)4L"
