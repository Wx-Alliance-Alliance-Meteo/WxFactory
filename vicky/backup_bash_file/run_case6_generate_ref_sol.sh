...
#SBATCH --output=vicky/EXODE_testoutput_case6/run_scripts/case6_ref_sol_%j.out
#SBATCH --error=vicky/EXODE_testoutput_case6/run_scripts/case6_ref_sol_%j.err
...
testoutputDir=$GEFDir/vicky/ref_sol_case6
mkdir $testoutputDir

# config file name
configFile=case6_ref_sol.ini

# testing stepsizes
stepsize="5" # 1.0 0.5 0.25 0.1"
...
do
	...
	testoutputSubDir=${testoutputDir}/tol_${tol}_dt_${dt}_tf_${tf}_grid_${nbsolpts}x${nb_elements}x${nb_elements}
