...
#spacial_dimension
nbsolpts=3
nb_elements_sel="42 84 168 336" # 672" # 168 336" # 168 336"
...
do
	...
	if [ $nb_elements -eq 42 ] 
	then 
		core=6
	elif [ $nb_elements -eq 84 ]
	then 
	 	core=24
	elif [ $nb_elements -eq 168 ]
        then
                core=96
	elif [ $nb_elements -eq 336 ]
        then
                core=384
	elif [ $nb_elements -eq 672 ]
        then
                core=1536
	else
