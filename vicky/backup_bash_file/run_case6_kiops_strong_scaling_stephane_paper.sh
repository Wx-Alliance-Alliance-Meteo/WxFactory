...
#SBATCH --output=vicky/EXODE_testoutput_case6/run_scripts/case6_kiops_strong_scaling_%j.out
#SBATCH --error=vicky/EXODE_testoutput_case6/run_scripts/case6_kiops_strong_scaling_%j.err
