...
#SBATCH --mem=300G
#SBATCH --time=6:00:00
#SBATCH --output=vicky/EXODE_testoutput_case6/run_scripts/case6_kiops_weak_scaling_%j.out
#SBATCH --error=vicky/EXODE_testoutput_case6/run_scripts/case6_kiops_weak_scaling_%j.err
