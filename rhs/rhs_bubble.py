...
def rhs_bubble(Q, geom, mtrx, nbsolpts, nb_elements_x, nb_elements_z):
   ...
   ifaces_enthalpy = (heat_capacity_ratio/(heat_capacity_ratio-1))*(ifaces_pres/ifaces_var[idx_2d_rho]) + 0.5*(ifaces_u**2 + ifaces_w**2)
   kfaces_enthalpy = (heat_capacity_ratio/(heat_capacity_ratio-1))*(kfaces_pres/kfaces_var[idx_2d_rho]) + 0.5*(kfaces_u**2 + kfaces_w**2)
