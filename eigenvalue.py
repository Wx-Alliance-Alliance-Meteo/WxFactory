...
def get_matvec_sw(cfg_file, rhs):
   ...
   if rhs == 'all':
      ...
      fullrhs = lambda q: rhs_sw(q, geom, mtrx, metric, topo, ptopo, param.nbsolpts, param.nb_elements, param.case_number, param.filter_apply)
      rhs_implicit = RhsCallerLowRes(rhs_sw_implicit, geom, mtrx, metric, topo, ptopo, param.nbsolpts, param.nb_elements, param.case_number, param.filter_apply, param = param, timers=None)
      rhs = lambda q: fullrhs(q) - rhs_implicit(q)
   elif rhs == 'imp':
      rhs = RhsCallerLowRes(rhs_sw_implicit, geom, mtrx, metric, topo, ptopo, param.nbsolpts, param.nb_elements, param.case_number, param.filter_apply, param = param, timers=None)
   else:
