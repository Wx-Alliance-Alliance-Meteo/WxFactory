...
#PBS -e ./testoutput/work_precision/case6_5x336/
#PBS -o ./testoutput/work_precision/case6_5x336/
...
#spacial_dimension
nbsolpts=5
nb_elements_sel="336" #336 336 336
#nb_elements=336
num_of_cores="10584"
...
# EXODE methods 
exodemethod="pmex" 
#'pmex','DP5(4)', 'M4(3)','KC3(2)','EXLRK3(2)','EXLRK4(3)','F14(12)','DP8(7)','F10(8)'
