...
class DG_preconditioner:
    ...
    def __init__(self, param, geometry, ptopo, operators, rhs_func, prefix="   ", depth=1):
        ...
        if param.equations != "shallow_water":
            raise ValueError(
                "Preconditioner is only implemented for the shallow water equations. "
    ...
    def apply(self, vec):
        ...
        print(
            f"{self.prefix}Preconditioned in {num_iter} iterations (total {self.total_num_iter()}) "
