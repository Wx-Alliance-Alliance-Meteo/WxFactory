...
#SBATCH --output=vicky/EXODE_testoutput_case6/run_scripts/case6_work_precision_exode_%j.out
#SBATCH --error=vicky/EXODE_testoutput_case6/run_scripts/case6_work_precision_exode_%j.err
...
tol_sel="1e-5" # 1e-7 1e-8 1e-9 1e-10 1e-11 1e-12"

# EXODE methods 
exodemethod="erk4(3)4l" #rk23 rk45 merson4 ark3(2)4l[2]sa-erk erk3(2)3l erk4(3)4l"  
#KIOPS RK23 RK45 MERSON4 ARK3(2)4L[2]SA-ERK ERK3(2)3L ERK4(3)4L
exode_controller_options="deadbeat" # h211b pi3040"

for exode_controller in  $exode_controller_options
do 

EPImethod=epi2
# Testoutput location and file
testoutputDir=/space/hall0/work/eccc/mrd/rpnatm/siw001/gef_data/case6/compare_controller/${EPImethod}_${exode_controller}
mkdir -p $testoutputDir

# config file name
configFile=case6_exode_${exode_controller}.ini

echo $exode_controller
...
exode_controller = ${exode_controller}"
			fi
