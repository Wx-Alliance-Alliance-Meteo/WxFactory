...
#SBATCH -J gef_p4096rk
#SBATCH -o gef_p4096rk.out
#SBATCH -e gef_p4096rk.error
#SBATCH -N 1  #how many cluster nodes #STEPHANE HAS TO CHANGE
#SBATCH -n 4096  #how many cores
#SBATCH --exclusive
#SBATCH -p short
...
for ((j = 0; j < $caselen; j++)); do
    mpirun -np 4096 python3 ./main_gef.py config/procs4096_epirk/${cases[$j]}
done
