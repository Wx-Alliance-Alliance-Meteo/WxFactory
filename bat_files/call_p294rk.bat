...
#SBATCH -J gef_p294rk
#SBATCH -o gef_p294rk.out
#SBATCH -e gef_p294rk.error
#SBATCH -N 2  #how many cluster nodes #STEPHANE HAS TO CHANGE
...
for ((j = 0; j < $caselen; j++)); do
    mpirun -np 294 python3 ./main_gef.py config/procs294_epirk/${cases[$j]}
done
