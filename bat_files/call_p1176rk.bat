...
#SBATCH -J gef_p1024rk
#SBATCH -o gef_p1024rk.out
#SBATCH -e gef_p1024rk.error
#SBATCH -N 1  #how many cluster nodes #STEPHANE HAS TO CHANGE
#SBATCH -n 1024  #how many cores
#SBATCH --exclusive
#SBATCH -p short
...
for ((j = 0; j < $caselen; j++)); do
    mpirun -np 1024 python3 ./main_gef.py config/procs1024_epirk/${cases[$j]}
done
