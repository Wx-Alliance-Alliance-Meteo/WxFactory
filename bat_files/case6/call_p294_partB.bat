...
methods=("case6_icwyne1s.ini" "case6_icwyiop.ini" "case6_pmex1s.ini" "case6_pmexne.ini" "case6_pmexne1s.ini" "case6_kiopsne.ini")

#methods=("case6.ini" "case6_pmex1s.ini" "case6_pmexne.ini" "case6_cwy1s.ini" "case6_icwy1s.ini" "case6_icwy1s_sm.ini" "case6_cwy1s_sm.ini")
