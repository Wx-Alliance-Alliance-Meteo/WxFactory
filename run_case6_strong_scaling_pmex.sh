...
#PBS -e ./testoutput/c6_epi5/case6_5x672/
#PBS -o ./testoutput/c6_epi5/case6_5x672/
...
#eval "$(/space/hall5/sitestore/eccc/mrd/rpnatm/siw001/miniforge3/bin/conda shell.bash hook)"
#conda activate gef 
...
#spacial_dimension
nbsolpts=5
nb_elements_sel="672"   # 168 168 168"
#nb_elements=168
num_of_cores="864 1176 2646 4704 10584"
#864 1176 2646 4704 10584"
tf=14400
#12, 14, 21,28, 42   #14400
...
do
	...
	testoutputDir=/space/hall5/sitestore/eccc/mrd/rpnatm/siw001/testoutput/case6/${EPImethod}_robert_round1
...
do	
	...
	do
		...
		do
			...
			# Testoutput location and file
			testoutputSubDir=${testoutputDir}/${exode_method}/case6_${nbsolpts}x${nb_elements}
