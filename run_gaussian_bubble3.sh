...
# config file name
configFile=gaussian_bubble_testOS2.ini

# testing stepsizes
stepsize="0.1 0.05 0.025 0.01"

# OS22 parameter
OS22param="0.3 0.4 0.5 0.6 0.7 0.8 0.9"
...
do
    ...
    #do
    #    echo $os22b
        timeIntegrator=crank_nicolson    #ros2
