...
CUDA_THREAD_LIMIT      = tuple[int, ...](cp.cuda.runtime.getDeviceProperties(i)["maxThreadsPerBlock"] \
                                         for i in range(CUDA_DEVICE_COUNT))
CUDA_BLOCK_SHAPE       = tuple[tuple[int, int, int], ...](cp.cuda.runtime.getDeviceProperties(i)["maxThreadsDim"] \
                                                          for i in range(CUDA_DEVICE_COUNT))
...
class _CudaKernelDecorator:
   ...
   """
   def __call__(self, dimspec: DimFun[*KernelArgs])  \
