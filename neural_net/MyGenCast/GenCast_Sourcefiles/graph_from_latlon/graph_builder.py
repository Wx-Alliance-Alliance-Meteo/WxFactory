...
from GenCast_Sourcefiles.graph_from_latlon import grid_mesh_connectivity, icosahedral_mesh, model_utils
...
radius_query_fraction_edge_length = 1 #0.6
...
class GraphBuilder:
    ...
    def __init__(
        ...
        #print((self._mesh[0]))
        #print(np.shape(self._mesh[1]))
        #print(np.shape(self._mesh[2]))
        #print(np.shape(self._mesh[3]))
        ##print(type(self._mesh[0].edges))
    ...
    def _init_grid_properties(self, grid_lat: np.ndarray, grid_lon: np.ndarray):
        ...
        print(np.shape(self._grid_nodes_lon))
    ...
    def _init_mesh_properties(self):
        ...
        print(np.shape(self._mesh_nodes_lat))
        print(np.shape(self._mesh_nodes_lon))
