...
In the Ryan Kiesler paper the processor is described as
...
from GenCast_Sourcefiles.graph_net_block import GraphProcessor


class Processor(torch.nn.Module):
    """Processor for latent graph on Mesh"""
