...
file = nc.Dataset('../../../Explore_ai/WxFactory/results/out_case2_base.nc', 'r')
...
nf_h_contra_11 = file.variables['h_contra_11']
nf_h_contra_12 = file.variables['h_contra_12']
nf_h_contra_21 = file.variables['h_contra_21']
nf_h_contra_22 = file.variables['h_contra_22']
...
print(np.max(nf_h_contra_11), " ", np.min(nf_h_contra_11), " " , np.mean(nf_h_contra_11))
print(np.max(nf_h_contra_12), " ", np.min(nf_h_contra_12), " " , np.mean(nf_h_contra_12))
print(np.max(nf_h_contra_21), " ", np.min(nf_h_contra_21), " " , np.mean(nf_h_contra_21))
print(np.max(nf_h_contra_22), " ", np.min(nf_h_contra_22), " " , np.mean(nf_h_contra_22))
print(np.max(nf_sqrt_g), " ", np.min(nf_sqrt_g), " " , np.mean(nf_sqrt_g))
print(np.max(nf_christie_1_01), " ", np.min(nf_christie_1_01), " " , np.mean(nf_christie_1_01))
print(np.max(nf_christie_1_02), " ", np.min(nf_christie_1_02), " " , np.mean(nf_christie_1_02))
print(np.max(nf_christie_1_11), " ", np.min(nf_christie_1_11), " " , np.mean(nf_christie_1_11))
print(np.max(nf_christie_1_12), " ", np.min(nf_christie_1_12), " " , np.mean(nf_christie_1_12))
print(np.max(nf_christie_2_01), " ", np.min(nf_christie_2_01), " " , np.mean(nf_christie_2_01))
print(np.max(nf_christie_2_02), " ", np.min(nf_christie_2_02), " " , np.mean(nf_christie_2_02))
print(np.max(nf_christie_2_12), " ", np.min(nf_christie_2_12), " " , np.mean(nf_christie_2_12))
print(np.max(nf_christie_2_22), " ", np.min(nf_christie_2_22), " " , np.mean(nf_christie_2_22))
...
for t in range(0, nf_height.shape[0]):    
    ...
    node_features_dataset = torch.cat((node_features_dataset, node_features.unsqueeze(0)), dim=0)
    #print(node_features)
...
torch.save(node_features_dataset, f'node_features_dataset_case2_base_DIM{nf_height.shape[0]}.6.30.30.pt')
torch.save(edges_dataset, f'edges_dataset_case2_base_DIM{nf_height.shape[0]}.6.30.30.pt')
