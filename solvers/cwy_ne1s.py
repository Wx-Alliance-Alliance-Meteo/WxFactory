...
"""
 ...
 --> full orthogonalization cwy with norm estimate + lagg normalization
...
def cwy_ne1s(τ_out, A, u, tol=1e-7, m_init=10, mmin=10, mmax=128, iop=2, task1=False):
    ...
    while τ_now < τ_end:
        ...
        while j < m:
            ...
            # 7. orthogonalization
            tmp = T[0:j, 0:j] @ global_vec[0:j, 1]
            V[j, :] -= tmp @ V[0:j, :]
