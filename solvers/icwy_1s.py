...
"""
 ---> Full ICWY with lagged normalization
     true 1sync implementation 
...
def icwy_1s(τ_out, A, u, tol=1e-7, m_init=10, mmin=10, mmax=128, iop=2, task1=False):
   ...
   """
    ...
    while τ_now < τ_end:
        ...
        # icwy with lagged normalization
        while j < m:
            ...
            # 7. set values for Hessenberg matrix
            H[0:j, j - 1] = tmp
