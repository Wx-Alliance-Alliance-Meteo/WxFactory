...
def matvec_fun(
    vec: numpy.ndarray, dt: float, Q: numpy.ndarray, rhs: numpy.ndarray, rhs_handle, method="complex"
) -> numpy.ndarray:
    if method == "complex":
...
def matvec_rat(
    vec: numpy.ndarray, dt: float, Q: numpy.ndarray, rhs: numpy.ndarray, rhs_handle: Callable
) -> numpy.ndarray:
