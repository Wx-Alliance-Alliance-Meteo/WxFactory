...
#PBS -N case6_strong_scaling_big_job 
#PBS -l select=133:nodes=133:ncpus=80:mem=400gb:mpiprocs=80:ompthreads=1
#PBS -l walltime=3:00:00 
#PBS -o case6_strong_scaling_$PBS_JOBID.out
#PBS -e case6_strong_scaling_$PBS_JOBID.err
