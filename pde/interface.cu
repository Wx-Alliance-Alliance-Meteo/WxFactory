...
__global__ void pointwise_eulercartesian_2d(const num_t *q, num_t *flux_x1, num_t *flux_x2, const int num_elem_x1, const int num_elem_x2, const int num_solpts_tot)
{
...
template <typename num_t>
__global__ void riemann_eulercartesian_ausm_2d(const num_t *q_itf, num_t *flux_itf, const int num_elem_x1, const int num_elem_x2, const int num_solpts, const int direction, const int nmax_x, const int nmax_y, const int nmax_z)
{
...
template <typename num_t>
__global__ void boundary_eulercartesian_2d(const num_t *q_itf, num_t *flux_itf, const int num_elem_x1, const int num_elem_x2, const int num_solpts, const int direction, const int nmax_x, const int nmax_y)
{
  const int ix = blockIdx.x * blockDim.x + threadIdx.x;
  const int iy = blockIdx.y * blockDim.y + threadIdx.y;
...
template <typename num_t>
void launch_pointwise_euler_cartesian_2d(py::object q, py::object flux_x1, py::object flux_x2, const int num_elem_x1, const int num_elem_x2, const int num_solpts_tot)
{
  ...
  pointwise_eulercartesian_2d<num_t><<<num_blocks, BLOCK_SIZE>>>(q_ptr, flux_x1_ptr, flux_x2_ptr, num_elem_x1, num_elem_x2, num_solpts_tot);
}

void select_pointwise_eulercartesian_2d(py::object q, py::object flux_x1, py::object flux_x2, const int num_elem_x1, const int num_elem_x2, const int num_solpts_tot)
{
  ...
  if (dtype == "float64")
  {
    launch_pointwise_euler_cartesian_2d<double>(q, flux_x1, flux_x2, num_elem_x1, num_elem_x2, num_solpts_tot);
  }
  else if (dtype == "complex128")
  {
    launch_pointwise_euler_cartesian_2d<complex_t>(q, flux_x1, flux_x2, num_elem_x1, num_elem_x2, num_solpts_tot);
  }
}

template <typename num_t>
void launch_riemann_eulercartesian_ausm_2d(py::object q_itf_x1, py::object q_itf_x2, py::object flux_itf_x1, py::object flux_itf_x2, const int num_elem_x1, const int num_elem_x2, const int num_solpts)
{
  // Extract CuPy pointers
  ...
  riemann_eulercartesian_ausm_2d<num_t><<<num_blocks1, threads_per_block>>>(q_x1_ptr, f_x1_ptr, num_elem_x1, num_elem_x2, num_solpts, 0, width, height, depth);
  ...
  riemann_eulercartesian_ausm_2d<num_t><<<num_blocks2, threads_per_block>>>(q_x2_ptr, f_x2_ptr, num_elem_x1, num_elem_x2, num_solpts, 1, width, height, depth);
  ...
  boundary_eulercartesian_2d<num_t><<<num_blocks3, threads_per_block2>>>(q_x1_ptr, f_x1_ptr, num_elem_x1, num_elem_x2, num_solpts, 0, width, height);
  ...
  boundary_eulercartesian_2d<num_t><<<num_blocks4, threads_per_block2>>>(q_x2_ptr, f_x2_ptr, num_elem_x1, num_elem_x2, num_solpts, 1, width, height);
}

void select_riemann_eulercartesian_ausm_2d(py::object q_itf_x1, py::object q_itf_x2, py::object flux_itf_x1, py::object flux_itf_x2, const int num_elem_x1, const int num_elem_x2, const int num_solpts)
{
  // Determine the CuPy array dtype
  ...
  if (dtype == "float64")
  {
    launch_riemann_eulercartesian_ausm_2d<double>(q_itf_x1, q_itf_x2, flux_itf_x1, flux_itf_x2, num_elem_x1, num_elem_x2, num_solpts);
  }
  else if (dtype == "complex128")
  {
    launch_riemann_eulercartesian_ausm_2d<complex_t>(q_itf_x1, q_itf_x2, flux_itf_x1, flux_itf_x2, num_elem_x1, num_elem_x2, num_solpts);
  }
}
